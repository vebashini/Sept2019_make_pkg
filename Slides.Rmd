...
- Thereafter exit window, and in your __terminal__ window type:
...
- Check Package<sup>1</sup>: In Build Menu -> click Check OR
...
.footnote[
[1] You should see some warnings about a license, and the undocumented functions.
]     
