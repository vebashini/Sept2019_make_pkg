...
- Check if the name you're thinking about `r emo::ji("thinking")` is available? Checks CRAN etc.

.pull-left[
```{r eval=FALSE, tidy=FALSE}
install.packages("available")
available::available("testthat")
```
]
.pull-right[
...
- NAMESPACE : how your package interacts with other packages and what you make available to the user
- R/ : code files
